        ...
        <>
            <div className="container register  py-5" >
                <div className="row w-100 mx-auto" >
                    <div className="col " >
                        <div className="card border-0  col-md-4 m-auto  px-4 px-md-5  py-4" >
                            <Form autoComplete='off' onFinish={handleFinish} onFinishFailed={handleFailure} style={{ textAlign: "center", }} >
                                <Title level={2} className='text-center mb-5 heading ' > Register </Title>
                                ...
                                <Form.Item name="password"
                                    rules={
                                        [{
                                            required: true,
                                            min: 6,
                                            message: "Please enter atleast 6 charcters"
                                        }]
                                    } hasFeedback >
                                ...
                                <Form.Item name="gender" hasFeedback >
                                    <Select name="gender" placeholder="Select Your Gender" >
                                        <Select.Option value="male" className="sideFont"> Male </Select.Option>
                                        <Select.Option value="female" className="sideFont" > Female </Select.Option>
                                    </Select>
                                </Form.Item>
                                <Form.Item name="aggrement"
                                    ...
                                    <Checkbox name="aggrement" >
                                        <p className='mb-0 sideFont' > Agree to our <Link href='/' > Terms and Conditions </Link></p >
                                    </Checkbox>
                                </Form.Item>
                                <Form.Item className='text-center' >

                                    <Button type='primary' htmlType='submit' className='w-50 sideFont' loading={isLoading} disabled={isLoading} >
                                        Register
                                    </Button>
                                </Form.Item>
                                <Form.Item className='text-center' >
                                    <p className='mb-0 sideFont' >Already have an account?
                                        <Link to="/auth/login" className='mx-2 sideFont' >Click Here</Link>
                                    </p >
                                </Form.Item>
                            </Form>
                        </div>
